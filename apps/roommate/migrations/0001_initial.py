    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lodging_description', models.CharField(help_text='e.g. Fully furnished 2BHK FLAT.', max_length=1000, null=True, validators=[django.core.validators.RegexValidator(message='Only digits, letters and follwing characters are allowed (.,\'"/)', regex='^[0-9a-zA-Z ,.\'"/]*$')])),
